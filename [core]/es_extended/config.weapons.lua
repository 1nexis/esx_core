...
Config.Weapons = {
	...
	{ name = 'WEAPON_XMASBALLS',       label = "XMAS Balls",       components = {} },
	...
	},
	{
		...
		components = {
			...
			{ name = 'clip_extended',   label = "CLIP 6",   hash = `COMPONENT_AK74_CLIP_06` },
			...
			{ name = 'flashlight',   label = "FLASH 4",   hash = `COMPONENT_AK74_FLSH_04` },
			{ name = 'grip',   label = "GRIP 1",   hash = `COMPONENT_AK74_GRIP_01` },
			...
			{ name = 'suppressor',   label = "MUZZLE 8",   hash = `COMPONENT_AK74_MUZ_08` },
			...
			{ name = 'scope',   label = "SCOPE 7",   hash = `COMPONENT_AK74_SCOPE_07` },
	...
	},
	{
		...
		components = {
			...
			{ name = 'clip_extended',   label = "CLIP 7",   hash = `COMPONENT_AKS74U_CLIP_07` },
			...
			{ name = 'flashlight',   label = "FLASH 7",   hash = `COMPONENT_AKS74U_FLSH_07` },
			...
			{ name = 'grip',   label = "HANDGUARD 8",   hash = `COMPONENT_AKS74U_HANDGUARD_08` },
			...
			{ name = 'suppressor',   label = "MUZZLE 7",   hash = `COMPONENT_AKS74U_MUZ_07` },
			...
			{ name = 'scope',   label = "SCOPE 17",   hash = `COMPONENT_AKS74U_SCOPE_17` },
	...
	},
	{
		...
		components = {
			...
			{ name = 'clip_extended',   label = "CLIP 4",   hash = `COMPONENT_ASVAL_CLIP_04` },
			{ name = 'flashlight',   label = "FLASH 1",   hash = `COMPONENT_ASVAL_FLSH_01` },
			...
			{ name = 'grip',   label = "GRIP 10",   hash = `COMPONENT_ASVAL_GRIP_10` },
			...
			{ name = 'scope',   label = "SCOPE 3",   hash = `COMPONENT_ASVAL_SCOPE_03` },
	...
	},
	{
		...
		components = {
			...
			{ name = 'clip_extended',   label = "CLIP 2",   hash = `COMPONENT_UMP_CLIP_02` },
			...
			{ name = 'grip',   label = "GRIP 9",   hash = `COMPONENT_UMP_GRIP_09` },
			...
			{ name = 'suppressor',   label = "SUPP 2",   hash = `COMPONENT_UMP_SUPP_02` },
			...
			{ name = 'scope',   label = "SCOPE 6",   hash = `COMPONENT_UMP_SCOPE_06` },
			...
			{ name = 'flashlight',   label = "FLASH 1",   hash = `COMPONENT_UMP_FLSH_01` },
